...
async def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            BotState.DONE_STATE: [MessageHandler(filters.TEXT & ~filters.COMMAND, lambda update, context: BotState.MAIN_MENU)], # Возврат в главное меню
        },
    ...
    application.add_handler(CallbackQueryHandler(resource_callback, pattern='^main_resource$'))
    ...
    # Запуск polling (правильный способ)
